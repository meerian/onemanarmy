...
function createSpriteSheet() {
    ...
    spritesheet["hurtleft"] = [new PIXI.Texture(ssheet, new PIXI.Rectangle(6 * rw, 0 * rh, rw, rh))];
    ...
    spritesheet["hurtright"] = [new PIXI.Texture(ssheet, new PIXI.Rectangle(6 * rw, 1 * rh, rw, rh))];
}
